...
var account_settings_name = document.getElementById("account_settings_name");
...
$.ajax({
    ...
    success: function(data) {
        ...
        if (data.startsWith("DATA:") == true) {
            ...
            account_settings_name.innerHTML = username;

            // Set the email fields
            email_field.innerHTML = email;
            account_settings_mail.innerHTML = email;

            // Set the phone field
            account_settings_phone.innerHTML = phone;
